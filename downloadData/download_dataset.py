#!/usr/bin/env python3
"""
Download BiomedVis Challenge 2025 dataset - Quality 3 (24GB)
"""
...
def download_biomedvis_dataset():
    """Download the complete 24GB dataset using S3 sync"""
    
    print("🚀 BiomedVis Challenge 2025 - Dataset Downloader")
    print("=" * 50)
    print("📊 Dataset: Quality 3 (24GB)")
    print("📁 Output: ./biomedvis-24gb/")
    print("⏱️  Time: 20-40 minutes")
    print("-" * 50)
    
    # Create output directory
    os.makedirs("./biomedvis-24gb", exist_ok=True)
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"daskArray = da.from_zarr('./biomedvis-24gb/0/3')")
